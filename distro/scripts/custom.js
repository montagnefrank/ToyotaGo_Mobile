function initSrc() {
    ...
    var pwaName = "ToyotaGO"; //Local Storage Names for PWA
    var pwaRemind = 1; //Days to re-remind to add to home
    var pwaNoCache = false; //Requires server and HTTPS/SSL. Will clear cache with each visit

    //Setting Service Worker Locations scope = folder | location = service worker js location
    var pwaScope = "/";
    var pwaLocation = "distro/_service-worker.js";
    ...
    function init_template() {
        ...
        if (locationBut.length) {
            ...
            function geoLocate() {
                ...
                if (!navigator.geolocation) { locationCoordinates.textContent = 'Geolocation is not supported by your browser'; } else {
        ...
        if (footerBar6) {
            ...
            footerBar6_circle.insertAdjacentHTML('beforeend', '<strong><u><img width="50" class="fluid-img rounded-m shadow-xl" src="' + apiURI + 'assets/img/icont.png"></u></strong>');
        }
